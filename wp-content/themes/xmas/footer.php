...
<div class="modal" id="alert">
  ...
  <p class="modal-text">Некоторые функции этого сайта не работают. Я делаю ту часть, которая видна пользователю. Если
    сайт нужно сделать с серверной частью, я работаю в паре с бэкенд-разработчиком</p>
